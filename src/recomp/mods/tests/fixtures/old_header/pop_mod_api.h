 ...
 */
/* tests/fixtures/old_header/pop_mod_api.h - the shipped header with
 * pop_cpu_v1 truncated after edi and everything below it deleted. A fixture
 * built against THIS sees a genuinely smaller sizeof(pop_cpu_v1), which is
 * what a plugin compiled a year ago sees. Nothing else differs. */
