...
// Drive the production commit path (present handlers, minimum duration,
// completion acknowledgement) through the installed gpu::Device - a
// gpu::FakeDevice in tests - with a drawable from `chain`.
